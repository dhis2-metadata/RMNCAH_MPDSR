# Maternal and Perinatal Death Surveillance and Response (MPDSR) Installation Guide { #rmncah_mpdsr-installation }

This document includes an installation guide for the Maternal and Perinatal Death Surveillance and Response package.
