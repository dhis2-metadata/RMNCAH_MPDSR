...
To address these challenges, **UNFPA** has developed the **DHIS2 MPDSR Toolkit** to digitize and harmonize MPDSR tools within national DHIS2 platforms. The toolkit converts the core MPDSR instruments—such as the **Situation Mapping Tool**, **Maternal Death Case Review Form**, and **Stillbirth and Neonatal Death Case Review Form** into interoperable digital components.
